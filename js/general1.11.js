...
//	    		var chosenName = $("#deliver_name").val();
//	    		var chosenAddress = $("#deliver_address1").val();
//	    		var chosenCourierType = $("#courier_type").val();
//	    		var chosenCourierCost = $("#courier_cost").val();
//	    		var chosenAddressType = $("#delivery_address_type").val();
//	    			
//	    		if(chosenName.length == 0 && chosenAddress.length == 0 && chosenCourierType.length == 0 && chosenCourierCost.length == 0 && chosenAddressType.length == 0){
//	    			$("#delivery-postal").prop('checked', true);
//	    			$("#postal-check").addClass( "selected-div" );
//	    		}
	    	break;
