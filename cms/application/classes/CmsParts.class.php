		...
		$vString .= "<article>";
			...
			$vString .= "<form name=\"bookForm\" id=\"bookForm\" method=\"post\" enctype=\"multipart/form-data\" action=\"book_process.php\">";
				$vString .= "<div class=\"border\">";
					...
					$vString .= General::returnSelect($pConn, $vLanguage, "language", "language", $vLanguageValue, $vLanguageDisplay, "", 1, "required");
				...
				$vString .= "<div class=\"border\">";
					...
					$vString .= General::returnInput($pConn, "text", "isbn", "isbn", $vResults[1][0], 20, 20, "", "", "required", "", "");
					$vString .= "<input type=\"hidden\" name=\"current_isbn\" id=\"current_isbn\" value=\"".$vResults[1][0]."\">";
					$vString .= "<span class=\"compulsory\"><i class=\"fa fa-asterisk\" aria-hidden=\"true\"></i></span>";
					$vString .= "<div>";
				...
				$vString .= "<div class=\"border\">";
					...
					$vString .= General::returnInput($pConn, "text", "title", "title", $vResults[4][0],100, 100, "", "", "required", "", "");
					$vString .= "<span class=\"compulsory\"><i class=\"fa fa-asterisk\" aria-hidden=\"true\"></i></span>";
				$vString .= "</div>";
				$vString .= "<div class=\"border\">";
					$vString .= "<label for=\"category\">Kategorie:</label>";
					$vCategories = MysqlQuery::getAllCategoriesPerSection($pConn, $vSectionId, 1);
					$vString .= General::returnSelect($pConn, $vResults[2][0], "category", "category", $vCategories[0], $vCategories[1], "", 1, "required");
					$vString .= "<span class=\"compulsory\"><i class=\"fa fa-asterisk\" aria-hidden=\"true\"></i></span>";
				$vString .= "</div>";
				$vString .= "<div class=\"border\">";
                    ...
                    if(isset($vResults[2][0])) {
                        ...
                        $vString .= General::returnSelect($pConn, $vResults[3][0], "sub_category", "sub_category", $vSubCategories[0], $vSubCategories[1], "", 1, "required");
                    }
                    else {
                        $vString .= "<select></select>";
                    }
					$vString .= "<span class=\"compulsory\"><i class=\"fa fa-asterisk\" aria-hidden=\"true\"></i></span>";
				$vString .= "</div>";
				$vString .= "<div class=\"border\">";
					$vString .= "<label for=\"author\">".($vSectionId == 1 ? "Outeur:" : "Graffiti note:")."</label>";
					$vString .= General::returnInput($pConn, "text", "author", "author", $vAuthor, 100, 150, "", "", ($vSectionId == 1 ? "required:" : ""), "", "");
					if($vSectionId == 1){
				...
				if($vSectionId == 1){
					$vString .= "<div class=\"border\">";
						...
						$vString .= General::returnInput($pConn, "text", "illustrator", "illustrator", $vResults[22][0],50, 50, "", "", "", "", "");
				...
				$vString .= "<div class=\"border\">";
					...
					$vString .= General::returnInput($pConn, "text", "translator", "translator", $vResults[23][0],50, 50, "", "", "", "", "");
					if($vSectionId == 1){
				...
				if($vSectionId == 1){
					...
					$vString .= General::returnSelect($pConn, $vResults[17][0], "publisher", "publisher", $vPublishers[0], $vPublishers[3], "", 1, "");
				}
				...
				$vString .= "<div class=\"border\">";
					...
					$vString .= General::returnTextarea($pConn, "summary", "summary", General::prepareStringForInputDisplay($vResults[5][0]), 130, 10, 3000, "", "");
				$vString .= "</div>";
				$vString .= "<div class=\"border\">";
					$vString .= "<label for=\"language\">".($vSectionId == 1 ? "Prys:" : "Retail price:")."</label>";
					$vString .= "R ".General::returnInput($pConn, "text", "price", "price", $vResults[8][0], 6,6, "", "", "required", "", "");
					$vString .= "<span class=\"compulsory\"><i class=\"fa fa-asterisk\" aria-hidden=\"true\"></i></span>";
					$vString .= "<div>";
				...
				$vString .= "<div class=\"border\">";
					...
					$vString .= "R ".General::returnInput($pConn, "text", "cost_price", "cost_price", $vResults[38][0], 6,6, "", "", "", "", "");
				$vString .= "</div>";
				$vString .= "</div>";
				if($vSectionId == 1){
					$vString .= "<div class=\"border\">";
						$vString .= "<label for=\"date_publish\">Publikasie datum:</label>";
						$vString .= "<input type=\"date\" class=\"small\" name=\"date_publish\" id=\"date_publish\" value=\"".$vResults[25][0]."\">";
						$vString .= "<span class=\"compulsory\"><i class=\"fa fa-asterisk\" aria-hidden=\"true\"></i></span>";
					$vString .= "</div>";
				}
				else {
				...
				$vString .= "<div class=\"no-border\">";
					...
					$vString .= "R ".General::returnInput($pConn, "text", "special_price", "special_price", $vResults[7][0], 6, 6, "", "", "required", "", "");
					$vString .= "<div>";
				...
				if($vSectionId == 1){
					$vString .= "<div class=\"border\">";
						($vResults[12][0] == 1 ? $vSpecialChecked = "checked" : $vSpecialChecked = "");
					...
					$vString .= "<div class=\"border\">";
						...
						$vString .= "R ".General::returnInput($pConn, "text", "default_discount", "default_discount", $vResults[26][0], 6, 6, "", "", "required", "", "")."&nbsp;e.g.&nbsp;0.2";
						$vString .= "<div>";
					...
					$vString .= "<div class=\"border\">";
						...
						$vString .= General::returnInput($pConn, "text", "soon_rank", "soon_rank", $vResults[33][0], 5, 5, "", "", "", "", "");
					$vString .= "</div>";
					$vString .= "<div>";
						($vResults[11][0] == 1 ? $vNewChecked = "checked" : $vNewChecked = "");
					...
					$vString .= "<div class=\"border\">";
						...
						$vString .= General::returnInput($pConn, "text", "new_rank", "new_rank", $vResults[31][0], 5, 5, "", "", "", "", "");
					$vString .= "</div>";
					$vString .= "<div class=\"no-border\">";
						($vResults[13][0] == 1 ? $vTopChecked = "checked" : $vTopChecked = "");
					...
					$vString .= "<div class=\"border\">";
						...
						$vString .= General::returnSelect($pConn, $vResults[14][0], "top_seller_rank", "top_seller_rank", $vRankNumber, $vRankNumber, "", 3, "");
					$vString .= "</div>";
					$vString .= "<div class=\"border\">";
