  ...
  //Export to Excel end
    ...
    var booksTable = $('#tableBooks').dataTable( {
        ...
        "columns": [{"orderable": false,"searchable": false},null,null,null,{"searchable": false},{"searchable": false},{"searchable": false},{"searchable": false}, {"searchable": false},{"searchable": false},{"searchable": false},
        	{"searchable": false},{"searchable": false},{"searchable": false},null,{"searchable": false},{"searchable": false}],
	    fixedHeader: {
	        footer: true
	    }
    });
	...
	var rotateTable = $('#rotateTable').DataTable( {
        ...
        "columns": [null,{"orderable": false, "searchable": false},{"searchable": false},{"searchable": false},{"searchable": false},{"searchable": false},{"searchable": false},{"searchable": false},{"orderable": false, "searchable": false}],
...
$(".saveButton").click( function() {
	...
	$.post("book_process.php", {type: "edit", book_id: vBookId, price: vPrice, special: vSpecial, special_price: vSpecial_price, bnew: vNew, top_seller: vTop_seller, out_print: vOut_print, in_stock: vInstock, publisher: vPublisher, default_discount:vDefault_discount, date_publish: vPublishDate, soon: vSoon, soon_discount: vSoonDiscount, soon_rank: vSoonRank, new_rank: vNewRank, tv: vTv, tv_date: vTvDate},function(result){
		if(result == 'success'){
...
$("[id^=tracking_email_]").on('click', function() {
	...
	if(vPosted == 51 || vPosted == 53){
		...
		if(vTracking.length == 0){
			...
			$("#pre_load").fadeIn("slow");
				   $.post("cms_order_process.php", {type: "posted", order_id: vOrderId, client_id: vClientId, courier_type: vCourierType, salt: vOrderSalt, tracking: vTracking, posted: vPosted},function(result){
					   	if (result == "success") {
					   		location.reload();
					     }
					   	else{
...
$("#bookForm #blob_path").change(function () {
	...
	$("#searchStationary").click( function() {alert(0);
