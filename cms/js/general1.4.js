...
$(".saveButton").click( function() {
	...
	$.post("book_process.php", {type: "edit", book_id: vBookId, price: vPrice, special: vSpecial, special_price: vSpecial_price, bnew: vNew, top_seller: vTop_seller, top_seller_rank: vTop_seller_rank, out_print: vOut_print, in_stock: vInstock, publisher: vPublisher, default_discount:vDefault_discount, date_publish: vPublishDate, soon_discount: vSoonDiscount, soon: vSoon},function(result){
		if(result == 'success'){
