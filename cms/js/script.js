...
function save(thePage) {
	...
	// display query string
		...
		document.location.href='index.php?page_id='+thePage+'&type='+document.form1.type.value+'&selected_id='+document.form1.selected_id.value+'&'+content;
	}
}
