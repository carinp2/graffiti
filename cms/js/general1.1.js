  ...
  //Export to Excel end
    ...
    var booksTable = $('#tableBooks').dataTable( {
        ...
        "columns": [{"orderable": false,"searchable": false},null,null,null,{"searchable": false},{"searchable": false},{"searchable": false},{"searchable": false}, {"searchable": false},{"searchable": false},{"searchable": false},
        	{"searchable": false},{"searchable": false},{"searchable": false},null,{"searchable": false},{"searchable": false},{"searchable": false},{"searchable": false},{"searchable": false}]
      });
   
   //Landing Page New book list
    var booksLandingNewTable = $('#booksLandingNewTable').dataTable( {
        "iDisplayLength": 20,
        "aLengthMenu": [[20, 40, 60, -1], [20, 40, 60, "All"]],
        "columns": [{"searchable": false},null,null,null,{"searchable": false},{"searchable": false},{"searchable": false},{"searchable": false}, {"searchable": false},{"searchable": false},{"searchable": false},
        	{"searchable": false},{"searchable": false},null,null,{"searchable": false},{"searchable": false},{"searchable": false},{"searchable": false},{"searchable": false},{"orderable": false,"searchable": false},{"orderable": false,"searchable": false}]
      });
    
	//Landing Page Topseller book list
	var booksLandingTopTable = $('#booksLandingTopTable').DataTable( {
	        rowReorder: true,
	        "iDisplayLength": 15,
	        "aLengthMenu": [[15, 30, 45, -1], [15, 30, 45, "All"]],
	        "columns": [null,{"searchable": false},null,null,null,{"searchable": false},{"searchable": false},{"searchable": false},{"searchable": false},{"searchable": false},{"searchable": false},
	        	{"searchable": false},{"searchable": false},null,null,{"searchable": false},{"searchable": false},{"searchable": false},{"searchable": false},{"searchable": false},{"orderable": false,"searchable": false},{"orderable": false,"searchable": false}]	        
	});
	
	//Landing Page Specials book list
	var booksLandingSpecialsTable = $('#booksLandingSpecialsTable').DataTable( {
	        rowReorder: true,
	        "iDisplayLength": 15,
	        "aLengthMenu": [[15, 30, 45, -1], [15, 30, 45, "All"]],
	        "columns": [null,{"searchable": false},null,null,null,{"searchable": false},{"searchable": false},{"searchable": false},{"searchable": false},{"searchable": false},{"searchable": false},
	...
	//Landing Page Specials book list
	var booksLandingSoonTable = $('#booksLandingSoonTable').DataTable( {
	        rowReorder: true,
	        "iDisplayLength": 15,
	        "aLengthMenu": [[15, 30, 45, -1], [15, 30, 45, "All"]],
	        "columns": [null,{"searchable": false},null,null,null,{"searchable": false},{"searchable": false},{"searchable": false},{"searchable": false},{"searchable": false},{"searchable": false},
	...
	var orderTable = $("#orderTable").DataTable( {
        ...
        "iDisplayLength": 15,
        "aLengthMenu": [[15, 30, 45, -1], [15, 30, 45, "All"]],
        "columns": [null,null,null,null,null,null,null,null,null,null,{"searchable": false},{"searchable": false},null, null,{"orderable": false, "searchable": false},{"orderable": false, "searchable": false}]
        //"sDom": '<"top"i>rt<"bottom"><"clear">',   	
	});	
...
//            $('td:eq(0),td:eq(3)', nRow).addClass( "dt-body-center" );
//          }
	});		
	...
	//Top seller reorder
	booksLandingTopTable.on( 'row-reorder', function ( e, diff, edit ){
	    for ( var i=0, ien=diff.length ; i<ien ; i++ ) {
	    	var rowData = booksLandingTopTable.row( diff[i].node ).data();
	    	$.post("book_process.php", {type: "update-topseller-rank", book_id: rowData[15], rank: diff[i].newData},function(result){
		    	if(result == 'success'){
...
$(".saveButton").click( function() {
	...
	var vDimensions = $("#dimensions_"+vBookId).val();
	var vWeight = $("#weight_"+vBookId).val();
	var vFormat = $("#format_"+vBookId).val();
	var vPages = $("#pages_"+vBookId).val();
	var vPublishDate = $("#pub_"+vBookId).val();

	$.post("book_process.php", {type: "edit", book_id: vBookId, price: vPrice, special: vSpecial, special_price: vSpecial_price, bnew: vNew, top_seller: vTop_seller, top_seller_rank: vTop_seller_rank, out_print: vOut_print, in_stock: vInstock, publisher: vPublisher, default_discount:vDefault_discount, dimensions: vDimensions, weight:vWeight, format: vFormat, pages: vPages, date_publish: vPublishDate},function(result){
		if(result == 'success'){
...
$("[id^=saveOrder_]").on('click', function() {
	...
	var vNote = $("#note_"+vOrderId).val();
	   $.post("cms_order_process.php", {type: "order", order_id: vOrderId, note: vNote, courier_type: vCourierType, courier_cost: vCourierCost, total_cost: vTotalCost, tracking_no: vTrackingNo},function(result){
	    	if(result == 'success'){
