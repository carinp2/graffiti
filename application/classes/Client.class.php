				...
				$vString .= "<div class=\"form-body\">";
						...
						$vString .="<div class=\"form-group\">";
							$vString .= "<div class=\"col-xs-12\">";
								...
								$vString .= "<input type=\"text\" name=\"firstname\" id=\"firstname\" value=\"".(isset($vResults[1][0]) ? $vResults[1][0] : '')."\" placeholder=\"".MysqlQuery::getText($pConn, 64)/*Naam*/."\" required size=\"50\" maxlength=\"50\"><i class=\"fa fa-asterisk fa-required red\" aria-hidden=\"true\"></i>";
							$vString .= "</div>";
							$vString .= "</div>";
						$vString .="</div>";
						$vString .="<div class=\"row\">";
							$vString .="<div class=\"form-group\">";
								$vString .= "<div class=\"col-xs-12\">";
									...
									$vString .= "<input type=\"text\" name=\"surname\" id=\"surname\" value=\"".(isset($vResults[2][0]) ? $vResults[2][0] : '')."\" placeholder=\"".MysqlQuery::getText($pConn, 65)/*Van*/."\" required size=\"50\" maxlength=\"50\"><i class=\"fa fa-asterisk fa-required red\" aria-hidden=\"true\"></i>";
								$vString .= "</div>";
							$vString .= "</div>";
						$vString .="</div>";
						$vString .="<div class=\"row\">";
						...
						$vString .="<div class=\"row\">";
							$vString .="<div class=\"form-group\">";
								$vString .= "<div class=\"col-xs-12\">";
									...
									$vString .= "<input type=\"text\" name=\"physical_address1\" id=\"physical_address1\" value=\"".(isset($vResults[12][0]) ? $vResults[12][0] : '')."\" placeholder=\"".MysqlQuery::getText($pConn, 70)/*Fisiese adres*/."\"  size=\"45\" maxlength=\"45\">";
								$vString .= "</div>";
							$vString .= "</div>";
						$vString .="</div>";
							$vString .="<div class=\"row\">";
								$vString .="<div class=\"form-group\">";
									$vString .= "<div class=\"col-xs-12\">";
										...
										$vString .= "<input type=\"text\" name=\"physical_address2\"  id=\"physical_address2\" value=\"".(isset($vResults[13][0]) ? $vResults[13][0] : '')."\" placeholder=\"\" required size=\"45\" maxlength=\"45\">";
								$vString .= "</div>";
							$vString .= "</div>";
						$vString .="</div>";
						$vString .="<div class=\"row\">";
							$vString .="<div class=\"form-group\">";
								$vString .= "<div class=\"col-xs-12\">";
									...
									$vString .= "<input type=\"text\" name=\"physical_city\" id=\"physical_city\" value=\"".(isset($vResults[14][0]) ?$vResults[14][0] : '')."\" placeholder=\"".MysqlQuery::getText($pConn, 98)/*Stad*/."\"  size=\"45\" maxlength=\"45\">";
								$vString .= "</div>";
							$vString .= "</div>";
						$vString .="</div>";
						$vString .="<div class=\"row\">";
							$vString .="<div class=\"form-group\">";
								$vString .= "<div class=\"col-xs-12\">";
									...
									$vString .= "<input type=\"text\" name=\"physical_province\" id=\"physical_province\" value=\"".(isset($vResults[15][0]) ? $vResults[15][0] : '')."\" placeholder=\"".MysqlQuery::getText($pConn, 248)/*Provinsie*/."\"  size=\"45\" maxlength=\"45\">";
								$vString .= "</div>";
							$vString .= "</div>";
						$vString .="</div>";
						$vString .="<div class=\"row\">";
							$vString .="<div class=\"form-group\">";
								$vString .= "<div class=\"col-xs-12\">";
									...
									$vString .= "<input type=\"text\" name=\"physical_country\" id=\"physical_country\" value=\"".(isset($vResults[16][0]) ? $vResults[16][0] : '')."\" placeholder=\"".MysqlQuery::getText($pConn, 229)/*Land*/."\"  size=\"45\" maxlength=\"45\">";
								$vString .= "</div>";
							$vString .= "</div>";
						$vString .="</div>";
						$vString .="<div class=\"row\">";
							$vString .="<div class=\"form-group\">";
								$vString .= "<div class=\"col-xs-12\">";
									...
									$vString .= "<input type=\"text\" name=\"physical_code\" id=\"physical_code\" value=\"".(isset($vResults[17][0]) ? $vResults[17][0] : '')."\" placeholder=\"".MysqlQuery::getText($pConn, 71)/*Poskode*/."\"   size=\"10\" maxlength=\"10\">";
								$vString .= "</div>";
							$vString .= "</div>";
						$vString .="</div>";
						if($pId <= 0){
...
// 						$vString .="</div>";
	...
	public static function getWishlist($pConn, $pId, $pTemp){
		...
		$vString = "<div id=\"user-wishlist\" class=\"tab-pane fade".($pTemp == 2 ? $vString .= " in active" : $vString .= "")."\">";
				$vString .= "<div class=\"form-header\">";
					$vString .="<div class=\"row\">";
						$vString .= "<div class=\"col-xs-12\">";
